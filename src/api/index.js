...
export const api = {
  ...
  reader: {
    ...
    search: (id, q) => http.get(`/reader/${id}/search`, { params: { q } }),
    addBookmark: (id, mark) => http.post(`/reader/${id}/bookmarks`, mark),
    removeBookmark: (id, idx) => http.delete(`/reader/${id}/bookmarks/${idx}`),
